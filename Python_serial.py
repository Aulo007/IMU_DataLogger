...
def buscar_dados_com_atalhos():
    ...
    try:
        ...
        print(f"Não consegui abrir a porta {PORTA_PICO}. Verifique se a porta está correta e livre.")
        return
    ...
    while True:
        ...
        if "Conteúdo do arquivo" in linha or "Leitura do arquivo" in linha or "Escolha o comando" in linha:
            continue
    ...
    if linhas_recebidas:
        ...
        print("--- FALHA: Nenhum dado de CSV foi recebido. Verifique se o arquivo existe no SD card. ---")
